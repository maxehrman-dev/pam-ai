...
function buildInput(payload) {
  ...
  const system =
    ...
    + " VERDICT FIRST: open the body with a plain-English call phrased against their numbers — e.g. \"Based on your numbers, this is a move worth making.\" / \"On your current numbers, this isn't worth it yet.\" Then give the reasoning. Never bury the verdict in a conditional at the end. If the math is genuinely too close to call, say that in the first sentence and name the one factor that would tip it. Always anchor the verdict to \"your numbers\"/\"your goal\" (it is a model output, not a promise), and never guarantee an outcome."
