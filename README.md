...
- If `DEMO_ACCESS_CODE` is missing, the prototype fallback accepts `PAMDEVTEAM`, `pam dev team`, or `pam demo`
...
- Optional: set `RESEND_AUDIENCE_ID` to sync waitlist signups into a Resend Audience for waitlist updates
